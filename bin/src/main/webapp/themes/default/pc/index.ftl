...
<meta name="description" content="还是小说" />
</#macro>  
...
<ul class="seeWell cf" id="${id}" style="${style}">
    ...
    <li>
       ...
       <#if article.fullflag ><img src="${contextPath}/themes/default/pc/images/only.png" alt="完本图标" class="topss png_bg"><#else><img src="${contextPath}/themes/default/pc/images/only2.png" class="topss png_bg" alt="连载中图标"></#if>
       <span class="l">
