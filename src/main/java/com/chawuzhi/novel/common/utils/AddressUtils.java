...
public class AddressUtils {
		 ...
		 public static Map<String, String> getAddresses(String content, String encodingString)  
		  ...
		  String returnStr = AddressUtils.getResult(urlStr, content, encodingString);  
		  if (returnStr != null) {  
		   // 处理返回的省市区信息  
		   ...
		   province= decodeUnicode(province);// 省份  
		            ...
		            for (int i = 0; i < temp.length; i++) {  
		                ...
		                case 1:  
		                    ...
		                    case 3:  
		                    	...
		                    	region = decodeUnicode(region);// 地区   
		                    break;  
		                    case 5:  
		          ...
		          /*  create_time timestamp without time zone,
		            country character varying(32), -- 国家
		            region character varying(32), -- 区域（华中）
		            province character varying(32), -- 省份
		            city character varying(32), -- 城市
		            area character varying(32), -- 城市区县
		            isp character varying(32), -- 运营商
		            remark character varying(500),*/
		    Map<String, String> address = new HashMap<String, String>();
		  //  String addres=country+","+region+","+province+","+city+","+area+","+isp;  
